export const mockEquipmentInfo = {
  ...
  instances: {
    '动设备|离心泵': [{ id: 1, name: 'P01 离心泵' }, { id: 2, name: 'P02 离心泵' }],
    '动设备|压缩机': [{ id: 3, name: 'C01 压缩机' }],
    '动设备|风机': [{ id: 4, name: 'F01 风机' }],
    '动设备|齿轮泵': [{ id: 5, name: 'G01 齿轮泵' }],
    '静设备|储罐': [{ id: 6, name: 'TK01 储罐' }, { id: 7, name: 'TK02 储罐' }],
    '静设备|换热器': [{ id: 8, name: 'E01 换热器' }],
    '静设备|反应器': [{ id: 9, name: 'R01 反应器' }],
    '电气设备|变压器': [{ id: 10, name: 'T01 变压器' }],
    '电气设备|配电柜': [{ id: 11, name: 'PC01 配电柜' }, { id: 12, name: 'PC02 配电柜' }],
    '管道设备|阀门': [{ id: 13, name: 'V01 阀门' }, { id: 14, name: 'V02 阀门' }],
  },
};
